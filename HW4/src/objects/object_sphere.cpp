...
void Sphere::build_box() {
    mbx.m_x = centerR_T[0] + centerR_T[3] + BOX_OFFSET;
    mbx.s_x = centerR_T[0] - centerR_T[3] - BOX_OFFSET;
    mbx.m_y = centerR_T[1] + centerR_T[3] + BOX_OFFSET;
    mbx.s_y = centerR_T[1] - centerR_T[3] - BOX_OFFSET;
    mbx.m_z = centerR_T[2] + centerR_T[3] + BOX_OFFSET;
    mbx.s_z = centerR_T[2] - centerR_T[3] - BOX_OFFSET;
}